...
Publications
======
1.	**Lin, X.**, Pultsina, K., Monto, S., Ye, C., Parviainen, T. Flexibility of Internal Attention: Divergent Spatiotemporal Profiles for Feature and Object Cueing (in press on Cerebral Cortex)
   
3.	Wang, Y. *, **Lin, X.** *, Ye, C. *, Parviainen, T., & Liu, Q. (2025). Contralateral delay activity tracks storage load in visual working memory: Evidence from the multiple objects tracking task. Journal of Cognitive Neuroscience. 1-10.
   
5.	Liu, R., Guo, L., **Lin, X.**, Nie, D., Astikainen, P., & Ye, C. (2024). Dimension-based retro-cue benefit in working memory does not require unfocused dimension removal. Frontiers in psychology, 15, 1433405.
