...
* 2.	Wang, Y. *, **Lin, X.** *, Ye, C. *, Parviainen, T., & Liu, Q. (2025). Contralateral delay activity tracks storage load in visual working memory: Evidence from the multiple objects tracking task. Journal of Cognitive Neuroscience. 1-10.
* 3.	Liu, R., Guo, L., **Lin, X.**, Nie, D., Astikainen, P., & Ye, C. (2024). Dimension-based retro-cue benefit in working memory does not require unfocused dimension removal. Frontiers in psychology, 15, 1433405.
